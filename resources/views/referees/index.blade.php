            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 style= "color: black">Referees</h4>
                      <a href="{{url('/referees/create')}}" class="btn btn-primary btn-sm">Add New Referee</a>
                      <div class="pull-right">
                       <a href="{{action('Excelcontroller@exportreferees')}}" class="btn btn-primary btn-sm">Download</a>   
                      </div>
                      </div>
    <hr>
