            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 style= "color: black">Fields</h4>
                      <a href="{{url('/fields/create')}}" class="btn btn-primary btn-sm">Enter New Field Details</a>
                      <div class="pull-right">
                     <a href="{{action('Excelcontroller@exportfields')}}" class="btn btn-primary btn-sm ">Download</a>                 
                     </div>
                      </div>
    <hr>
