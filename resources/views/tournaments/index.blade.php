        ...
        <div class="col-md-15 col-md-offset-0">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    @if (Auth::check())
                        @role('admin')
                      <a href="{{url('/tournaments/create')}}" class="btn btn-primary btn-sm">Add New Tournament</a>
                      <div class="pull-right">
                       <a href="{{action('Excelcontroller@exporttournaments')}}" class="btn btn-primary btn-sm">Export to excel</a>   
                      </div>
                      </div>
                @endrole
                @endif
